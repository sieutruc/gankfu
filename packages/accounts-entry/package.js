...
Package.onUse(function(api) {
  ...
  api.use(['softwarerero:accounts-t9n', 'joshowens:simple-form', 'sacha:spin','aldeed:simple-schema'], ['client', 'server']);
  // CLIENT
  api.use([
    'deps',
  ...
  api.addFiles(['shared/accountSchema.js'], ['client', 'server']);
...
Package.onTest(function (api) {
  ...
  api.use(['softwarerero:accounts-t9n', 'joshowens:simple-form'], ['client', 'server']);
